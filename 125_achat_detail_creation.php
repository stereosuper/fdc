            ...
            <div id="lb" class="on">
                ...
                <div class="lightbox-content">
                    <div class="wrapper">
                        ...
                        <div class='field-content low-padding-top'>
                            ...
                            <form action='#' method='post' id='formToEdit' class='sale-form'>
                                ...
                                <button type='submit' class='btn-block huge btn-rouge'><span class='border'></span><span class='txt-btn'>Valider</span></button>
                            </form>
                        </div>
                    </div>
                </div>
