	...
	<body class='cercle'>
		...
		<main id='main' role='main'>
			...
			<div class='container-small'>
			    ...
			    <div class='wrapper-alignment wrapper-cols-cercle'>
					<div class='content-align-top wrapper-form-cercle'>
						<div class='content-tabs'>
						    <div class='tab-content form-contact'>
						        <form action='#' method='post' id='formToEdit'>
						            ...
						            <button type='submit' class='btn-block huge btn-orange-cercle'>
						...
						<div class='content-rappel'>
							...
							<form action='#' method='post'>
                                ...
                                <fieldset class='required no-asterisk'>
                                    ...
                                    <textarea id='creneau-rappel'></textarea>
                                </fieldset>
                                <button type='submit' class='btn-block btn-orange-cercle'>
									<span class='border'></span>
									<span class='txt-btn'>Envoyer</span>
                                </button>
                            </form>
						</div>
					</div>
